REGLAS_GRAMATICA = {
    ...
    #"parameter_list": ["':' {id} param_lista", "ε"],
    ...
    "comando": ["'move:' number 'inDir:' {direccion} '.'","'turn:' {direccion} '.'","'put:' id 'ofType:' object_type '.'","'pick:' identificador 'ofType:' object_type '.'","'goTo:' number 'with:' number '.'","'nop.'",],
    "asignar": ["{id} ':=' expre '.'"],
    "expre": ["number", "id"],
    ...
    "condicion": [
        ...
        "'canPick:' number 'ofType:' objeto_tipo",
        "'not:' {condicion}",],
    "ciclo": ["'while:' {condicion} 'do:' '[' {bloque} ']'"],
    "llamada_procedimiento": ["id {argument_list} '.'"],
    "argument_list": ["':' expre {argument_list}", "{bloque}"],
